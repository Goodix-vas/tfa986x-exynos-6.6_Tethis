...
#include "versions.h"
	...
	#define TFA98XX_API_REV_STR "v6.13.0+-Apr.01,2024"
#endif
...
#define TFAxx_FAM(fieldname) (TFA9866_BF_##fieldname)
...
/*
 * wait for a certain manstate to become active,
 * until a certain loop count is reached
 * @param tfa the device struct pointer
